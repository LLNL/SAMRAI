...
private:
   ...
   static std::shared_ptr<std::multimap<std::string, RefineOperator *>> s_lookup_table;
   std::weak_ptr<std::multimap<std::string, RefineOperator *>> l_lookup_table = s_lookup_table;
