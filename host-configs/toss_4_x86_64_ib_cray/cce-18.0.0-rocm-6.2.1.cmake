...
set(CMAKE_HIP_COMPILER "/usr/tce/packages/cce-tce/cce-18.0.0/bin/crayCC" CACHE PATH "")
...
# set(HIP_HIPCC_FLAGS "-D__HIP_ROCclr__ -D__HIP_PLATFORM_AMD__ -DCAMP_USE_PLATFORM_DEFAULT_STREAM -D__HIP_ARCH_GFX90A__=1 --rocm-path=/opt/rocm-6.2.1 -std=c++20 -x hip --offload-arch=gfx942" CACHE STRING "")
...
set(CMAKE_CXX_FLAGS "-std=c++20" CACHE STRING "")
...
set(HIP_HIPCC_FLAGS "-D__HIP_ROCclr__ -D__HIP_PLATFORM_AMD__ -DCAMP_USE_PLATFORM_DEFAULT_STREAM -std=c++20 -x hip --offload-arch=gfx942" CACHE STRING "")

set(MPI_CXX_COMPILER_INCLUDE_DIRS "/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.30-cce-18.0.0/include" CACHE STRING "")
set(MPI_CXX_LINK_FLAGS "-Wl,-rpath,/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.30-cce-18.0.0/ib -Wl,-rpath,/opt/cray/libfabric/2.1/lib64:/opt/cray/pe/pmi/6.1.14/lib:/opt/cray/pe/pals/1.2.12/lib:/opt/cray/pe/cce/18.0.0/cce/x86_64/lib:/opt/rocm-6.2.1/llvm/lib -L/opt/cray/pe/mpich/8.1.30/gtl/lib -lmpi_gtl_hsa" CACHE STRING "")
set(MPI_C_LINK_FLAGS "-Wl,-rpath,/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.30-cce-18.0.0/lib -Wl,-rpath,/opt/cray/libfabric/2.1/lib64:/opt/cray/pe/pmi/6.1.14/lib:/opt/cray/pe/pals/1.2.12/lib:/opt/cray/pe/cce/18.0.0/cce/x86_64/lib:/opt/rocm-6.2.1/llvm/lib" CACHE STRING "")
set(MPI_Fortran_LINK_FLAGS "-Wl,-rpath,/usr/tce/packages/cray-mpich-tce/cray-mpich-8.1.30-cce-18.0.0/lib -Wl,-rpath,/opt/cray/libfabric/2.1/lib64:/opt/cray/pe/pmi/6.1.14/lib:/opt/cray/pe/pals/1.2.12/lib:/opt/cray/pe/cce/18.0.0/cce/x86_64/lib:/opt/rocm-6.2.1/llvm/lib" CACHE STRING "")
